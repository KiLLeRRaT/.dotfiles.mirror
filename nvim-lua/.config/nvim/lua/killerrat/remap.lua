...
vim.keymap.set("n", "<F2>", ":checkhealth lsp<cr>")
...
vim.keymap.set("n", "]G", ":lua vim.diagnostic.jump({count=1, float=false, severity=vim.diagnostic.severity.ERROR})<cr>")
vim.keymap.set("n", "[G", ":lua vim.diagnostic.jump({count=-1, float=false, severity=vim.diagnostic.severity.ERROR})<cr>")
vim.keymap.set("n", "]g", ":lua vim.diagnostic.jump({count=1, float=false})<cr>")
vim.keymap.set("n", "[g", ":lua vim.diagnostic.jump({count=-1, float=false})<cr>")
